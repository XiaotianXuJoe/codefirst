...
const projects = [
  ...
  },
  {
    ...
    lines: '~90行',
    stack: ['Python', 'requests'],
    description: '调用 DeepSeek API 实现命令行 AI 对话，学习 Prompt 设计和 API 调用基础。',
    resumeValue: '大模型 API 调用 · Prompt 工程 · 异常处理',
  ...
  },
  {
    ...
    description: '多轮对话 + 多会话管理 + 系统提示词定制 + JSON 持久化。完整对话系统入门。',
    resumeValue: '对话状态管理 · 数据持久化 · 系统提示词',
  ...
  },
  {
    ...
    lines: '~300行',
    stack: ['Python', 'requests', 'JSON'],
    description: '大模型自动判断调用哪个工具（天气/计算/搜索/时间），实现 Function Calling 入门。',
    resumeValue: 'Function Calling · 工具注册 · 意图路由',
  ...
  },
  {
    ...
    time: '5-7小时',
    lines: '~400行',
    stack: ['Python', 'requests', 'ChromaDB'],
    description: '文档上传 → 切分向量化 → 向量检索 → 大模型生成回答。RAG 完整流程实战。',
    resumeValue: 'Embedding · 向量检索 · 检索增强生成',
...
function StatsSection() {
  ...
  const stats = [
    { number: 12, suffix: '+', label: '精选项目' },
    { number: 4, suffix: '', label: '难度等级' },
